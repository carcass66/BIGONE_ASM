...
RESET:			LDI temp, Low(RAMEND)
				...
				IN temp, PINC															;Save current value of PINC
				MOV PINC_OLD, temp
...
;====================================================================================
WHEEL_COUNTER:	;io?ii i?e iiiiue n?aaiaiey PINC_OLD n PINC ii?aaaeeou eaeie ec ieiia ni?iaioe?iaae i?a?uaaiea,
				IN reg, PINC															;Load current value of PINC to reg
				MOV temp, PINC_OLD
				ANDI reg, temp														;Load old value of PINC to temp 
